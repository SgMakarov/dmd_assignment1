...
\.
COPY actor (actor_id, first_name, last_name, last_update) FROM '/dvdrental/2163.dat';
...
\.
COPY address (address_id, address, address2, district, city_id, postal_code, phone, last_update) FROM '/dvdrental/2171.dat';
...
\.
COPY category (category_id, name, last_update) FROM '/dvdrental/2165.dat';
...
\.
COPY city (city_id, city, country_id, last_update) FROM '/dvdrental/2173.dat';
...
\.
COPY country (country_id, country, last_update) FROM '/dvdrental/2175.dat';
...
\.
COPY customer (customer_id, store_id, first_name, last_name, email, address_id, activebool, create_date, last_update, active) FROM '/dvdrental/2177.dat';
...
\.
COPY film (film_id, title, description, release_year, language_id, rental_duration, rental_rate, length, replacement_cost, rating, last_update, special_features, fulltext) FROM '/dvdrental/2167.dat';
...
\.
COPY film_actor (actor_id, film_id, last_update) FROM '/dvdrental/2168.dat';
...
\.
COPY film_category (film_id, category_id, last_update) FROM '/dvdrental/2169.dat';
...
\.
COPY inventory (inventory_id, film_id, store_id, last_update) FROM '/dvdrental/2179.dat';
...
\.
COPY language (language_id, name, last_update) FROM '/dvdrental/2181.dat';
...
\.
COPY payment (payment_id, customer_id, staff_id, rental_id, amount, payment_date) FROM '/dvdrental/2183.dat';
...
\.
COPY rental (rental_id, rental_date, inventory_id, customer_id, return_date, staff_id, last_update) FROM '/dvdrental/2185.dat';
...
\.
COPY staff (staff_id, first_name, last_name, address_id, email, store_id, active, username, password, last_update, picture) FROM '/dvdrental/2187.dat';
...
\.
COPY store (store_id, manager_staff_id, address_id, last_update) FROM '/dvdrental/2189.dat';
